...
O objetivo é documentar a aplicação prática de conhecimentos, explorar conceitos e frameworks, registrar aprendizados e construir um portfólio que demonstre evolução profissional por meio de **evidências concretas**.

Entre os conteúdos publicados estão:
